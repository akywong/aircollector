...
{  
	...
	GPIO_PinRemapConfig(GPIO_FullRemap_TIM3, ENABLE);   //设置输出TIM3 CH1的PWM脉冲波形	GPIOC6
...
{  
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_9;//GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9; //TIM_CH1
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;  //复用推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
